                    ...
                    <div class="page-area pt-2 pb-2">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <ul class="pagination m-0">
                                ...
                                <li class="page-item"><a class="page-link" href="http://localhost/paustik-poornahar-admin/admin/food/list?page=2">2</a></li>
                                <li class="page-item"><a class="page-link" href="http://localhost/paustik-poornahar-admin/admin/food/list?page=3">3</a></li>
                                <li class="page-item">
