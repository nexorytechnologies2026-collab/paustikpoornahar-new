                ...
                <div class="card card-body">
                        ...
                        <div class="">
                            <div class="__input-tab {{  $landing_integration_type == 'url'?'active':''  }}" id="url">
                                <div class="form-group mb-20">
                                    ...
                                    <input type="url" id="redirect_url_input" placeholder="{{ translate('messages.Ex: https://yourdomain.com/') }}" class="form-control h--45px" name="redirect_url" value="{{ $redirect_url }}">
                                </div>
                    ...
                    <div class="__bg-F8F9FC-card d-flex flex-wrap gap-3 align-items-center justify-content-between">
                         <div class="">
                            ...
                            <p class="fs-12 mb-0">{{ translate('messages.Paustik Poornahar Default Admin Landing Page.') }}</p>
                        </div>
