                ...
                <div class="collapse" id="collapseGeneralSetup_032">
                    ...
                    <div class="card card-body mt-3">
                        <div class="">
                            ...
                            <ul class="mb-0">
                                <li>{{translate('To encourage new restaurant owners to register and partner with your Paustik Poornahar platform and to provide a download link for the restaurant management app.')}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="card card-body mt-3">
