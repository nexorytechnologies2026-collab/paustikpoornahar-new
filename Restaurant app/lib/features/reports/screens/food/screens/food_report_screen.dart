...
import 'package:paustik_poornahar_restaurant/features/reports/screens/food/widget/food_report_details_card_widget.dart';
import 'package:paustik_poornahar_restaurant/features/reports/screens/food/widget/line_chart_widget.dart';
        ...
        body: GetBuilder<ReportController>(builder: (reportController) {
          return reportController.foods != null ? SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              ) : EmptyStateWidget(title: 'no_food_found'.tr, topPadding: 60)
