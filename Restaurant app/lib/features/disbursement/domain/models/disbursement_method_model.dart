...
class Methods {
  ...
  String? methodName;
  List<DisMethodFields>? methodFields;
  int? isDefault;
  String? createdAt;
  String? updatedAt;
  ...
  Methods.fromJson(Map<String, dynamic> json) {
    ...
    if (json['method_fields'] != null) {
      methodFields = <DisMethodFields>[];
      json['method_fields'].forEach((v) {
        methodFields!.add(DisMethodFields.fromJson(v));
      });
    }
...
class DisMethodFields {
  String? userInput;
  String? userData;

  DisMethodFields({this.userInput, this.userData});

  DisMethodFields.fromJson(Map<String, dynamic> json) {
