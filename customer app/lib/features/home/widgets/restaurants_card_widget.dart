import 'package:paustik_poornahar/common/widgets/custom_favourite_widget.dart';
...
import 'package:paustik_poornahar/features/home/widgets/icon_with_text_row_widget.dart';
import 'package:paustik_poornahar/features/home/widgets/overflow_container_widget.dart';
...
import 'package:paustik_poornahar/common/widgets/custom_image_widget.dart';
import 'package:paustik_poornahar/common/widgets/not_available_widget.dart';
...
class RestaurantsCardWidget extends StatelessWidget {
  ...
  final bool? isNewOnPaustikPoornahar;
  const RestaurantsCardWidget({super.key, this.isNewOnPaustikPoornahar, required this.restaurant});
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Container(
          width: isNewOnPaustikPoornahar! ? ResponsiveHelper.isMobile(context) ? 330 : 380  : ResponsiveHelper.isMobile(context) ? 330: 355,
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Row(children: [
                  Stack(
                    children: [
                      Container(
                        padding: EdgeInsets.all(isNewOnPaustikPoornahar! ? 2 : 3),
                        height: isNewOnPaustikPoornahar! ? 95 : 65, width: isNewOnPaustikPoornahar! ? 95 : 65,
                        decoration:  BoxDecoration(
                        ...
                        child: ClipRRect(
                          ...
                          child:  CustomImageWidget(
                            image: '${restaurant.logoFullUrl}',
                                fit: BoxFit.cover, height: isNewOnPaustikPoornahar! ? 95 : 65, width: isNewOnPaustikPoornahar! ? 95 : 65,
                            isRestaurant: true,
                          ),
                        ),
                      ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: isNewOnPaustikPoornahar! ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeExtraSmall),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          isNewOnPaustikPoornahar! ? restaurant.freeDelivery! ? ImageWithTextRowWidget(
                          ...
                          isNewOnPaustikPoornahar! ? const SizedBox(width : Dimensions.paddingSizeExtraSmall) : const SizedBox(width: Dimensions.paddingSizeSmall),

                          isNewOnPaustikPoornahar! ? ImageWithTextRowWidget(
                          ...
                          isNewOnPaustikPoornahar! ? const SizedBox(width : Dimensions.paddingSizeExtraSmall) : restaurant.freeDelivery! ? const SizedBox(width: Dimensions.paddingSizeSmall) : const SizedBox(),
                ...
                isNewOnPaustikPoornahar! ? const SizedBox() : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
...
class RestaurantsCardShimmer extends StatelessWidget {
  final bool? isNewOnPaustikPoornahar;
  const RestaurantsCardShimmer({super.key, this.isNewOnPaustikPoornahar});

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: isNewOnPaustikPoornahar! ? 300 : ResponsiveHelper.isDesktop(context) ? 160 : 130,
      child: isNewOnPaustikPoornahar! ? GridView.builder(
