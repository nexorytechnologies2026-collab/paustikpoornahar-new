...
ThemeData dark = ThemeData(
  ...
  secondaryHeaderColor: const Color(0x9B22B04A),
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFF22B04A))),
  colorScheme: const ColorScheme.dark(primary: Color(0xFF22B04A),
    tertiary: Color(0xFFD62840),
    tertiaryContainer: Color(0xFF7A0617),
    secondary: Color(0x9B22B04A)).copyWith(surface: const Color(0xFF272727)).copyWith(error: const Color(0xFFdd3135),
  ),
